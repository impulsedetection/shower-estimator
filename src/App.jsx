      ...
      <div style={{ display: "grid", gridTemplateColumns: "540px 1fr", gap: 16 }}>
        ...
        <div style={uiCard}>
          ...
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeBacker} onChange={(e) => setIncludeBacker(e.target.checked)} /> Include backer sheets
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeBackerScrews} onChange={(e) => setIncludeBackerScrews(e.target.checked)} /> Include backer screws
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeBackerTape} onChange={(e) => setIncludeBackerTape(e.target.checked)} /> Include mesh tape
          </label>
          ...
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeWaterproofing} onChange={(e) => setIncludeWaterproofing(e.target.checked)} /> Include waterproofing
          </label>
          <div style={{ marginBottom: 10 }}>
          ...
          {includeWaterproofing && wpSystem === "sheet" && (
            <div style={{ border: "1px solid #eee", borderRadius: 12, padding: 10, marginBottom: 10 }}>
              ...
              <label style={{ display: "block", marginBottom: 6 }}>
                <input type="checkbox" checked={includeBanding} onChange={(e) => setIncludeBanding(e.target.checked)} /> Include banding
              </label>
              <div>
          ...
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeAdhesive} onChange={(e) => setIncludeAdhesive(e.target.checked)} /> Include adhesive
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeSilicone} onChange={(e) => setIncludeSilicone(e.target.checked)} /> Include silicone
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={seamsUseTrim} onChange={(e) => setSeamsUseTrim(e.target.checked)} /> Seams use H-joint trim (not sealant)
          </label>

          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeInsideCornerTrim} onChange={(e) => setIncludeInsideCornerTrim(e.target.checked)} /> Inside corner trim
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeEdgeTrim} onChange={(e) => setIncludeEdgeTrim(e.target.checked)} /> Edge/J-trim
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeTopTrim} onChange={(e) => setIncludeTopTrim(e.target.checked)} /> Top trim
          </label>
          <label style={{ display: "block", marginBottom: 6 }}>
            <input type="checkbox" checked={includeBottomTrim} onChange={(e) => setIncludeBottomTrim(e.target.checked)} /> Bottom trim
          </label>
          ...
          <label style={{ display: "block", marginBottom: 8 }}>
            <input type="checkbox" checked={includePanelPrice} onChange={(e) => setIncludePanelPrice(e.target.checked)} /> Include panel price in total
          </label>
